...
const manifesto = [
  {
    ...
    body: "I am a passionate full-stack developer on a mission to prove that one person with purpose and skill can change the way businesses grow. Every line of code I write, every problem I solve, and every client I serve is a step toward showing the world what I am truly capable of. I exist to build digital solutions that matter, to show up with everything I have, and to leave every client better than I found them.",
  },
  {
    tag: "Vision",
    quote: "Building a legacy, not just a career.",
    body: "I see a future where my name stands for excellence, where the agency I built from nothing becomes proof that passion and determination can turn a dream into something real. I am not just building a career, I am building a legacy. A legacy that shows the world that a developer who started alone, made himself sought after, hireable, and indispensable, had the fire, the focus, and the will to build something truly extraordinary.",
  },
];
