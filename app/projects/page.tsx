...
const projects: Project[] = [
  {
    ...
    year: "2025",
    description: "Online church services booking and management system — Capstone Project",
    mainImage: "/projects/main_image.png",
    technologies: ["Next.js", "React", "Laravel API", "MySQL", "Tailwind CSS", "Git"],
    fullDescription: "A modern web platform designed to streamline church service bookings and appointment management. FaithSeeker enables churchgoers to reserve slots for various religious services, while administrators can efficiently manage schedules, track appointments, and generate official documents like baptismal and marriage certificates. The system features a React/Next.js frontend with Tailwind CSS styling, powered by a Laravel RESTful API backend and MySQL database.",
    features: [
    ...
    subImages: [
      ...
      { url: "/projects/sub_owner_image2.png", caption: "Admin Panel - Schedule and appointment management" },
  ...
  },
  {
    ...
    subImages: [
      ...
      { url: "/projects/sub_image_report.png", caption: "Generated class schedule report" },
      { url: "/projects/sub_image_report2.png", caption: "Faculty workload report" },
    ],
    pdfReports: [
